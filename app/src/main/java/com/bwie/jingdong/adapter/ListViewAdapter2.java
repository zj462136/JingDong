...
public class ListViewAdapter2 extends RecyclerView.Adapter<ListViewAdapter2.ListViewHolder>{
    Context context;
    List<ZiZiFenLeiBean.DataBean> data;
    private ItemClickListener itemClickListener;

    public ListViewAdapter2(Context context, List<ZiZiFenLeiBean.DataBean> data) {
